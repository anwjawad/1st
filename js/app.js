...
const DEFAULTS = {
  ...
  bridgeUrl: 'https://script.google.com/macros/s/AKfycbxPkcetnotufRSMiYjP8u13RP-rJvn2eSvfBYl-CXc-vEVo-bmQj6XARBGexh6GCDc4/exec'
};
...
function renderPatientsList(){
  ...
  items.forEach(p=>{
    ...
    cb.checked = State.sel.has(p['Patient Code']);
